...
BEGIN {
	required["github.com/lattice-substrate/jcs-schubfach/cmd/jcs-offline-replay"] = 1
	required["github.com/lattice-substrate/jcs-schubfach/cmd/jcs-offline-worker"] = 1
	required["github.com/lattice-substrate/jcs-schubfach/offline/runtime/executil"] = 1
}
/^mode:/ { next }
{
	path = $1
